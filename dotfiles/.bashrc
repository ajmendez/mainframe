...
# bashrc
# 2014 Mendez
[[ !"${BASH_CONFIG}" ]] && export BASH_CONFIG="${HOME}/.local/etc/mainframe/dotfiles"
...
#                   in other scripts.
# BASH_CONFIG : Directory where you store the bash configurations. most will have this
#               their bare home directory, but I like it under Dropbox.

EXPORT_FUNCTIONS=false
# export BASH_CONFIG="${HOME}" 

# Information
# -----------
#
# To Enable:
# ln -s ${PWD}/.bashrc ~/.bashrc; ln -s ${PWD}/.bashrc ~/.bash_profile; ln -s ${PWD}/.bashrc ~/.bash_login
#
# Load Order:
